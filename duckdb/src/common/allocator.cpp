...
#endif
#ifdef REMON_MALLOC
	auto result = (data_ptr_t)vmm.remon_malloc(size);
#endif
	return result;
}
...
#endif
#ifdef REMON_MALLOC
	cout << "Warning: did not expect a reallocate, perf is low as I am doing memcpy" << endl;
	void* new_addr = vmm.remon_malloc(size);
